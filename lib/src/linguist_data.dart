...
abstract final class Language {
  ...
  /// The information provided by linguist about
  /// the "BibTeX Style" language or content type.
  static const LanguageInfo bibtexStyle = LanguageInfo(
    name: 'BibTeX Style',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.bst'],
  ...
  /// The information provided by linguist about
  /// the "BuildStream" language or content type.
  static const LanguageInfo buildStream = LanguageInfo(
    name: 'BuildStream',
    type: LanguageType.data,
    aliases: [],
    extensions: ['.bst'],
  ...
  /// The information provided by linguist about
  /// the "HIP" language or content type.
  static const LanguageInfo hip = LanguageInfo(
    name: 'HIP',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.hip'],
  ...
  /// The information provided by linguist about
  /// the "ISPC" language or content type.
  static const LanguageInfo ispc = LanguageInfo(
    name: 'ISPC',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.ispc'],
    filenames: [],
    interpreters: [],
    linguistColor: '#2D68B1',
    aceMode: 'c_cpp',
    codeMirrorMode: 'clike',
    codeMirrorMimeType: 'text/x-csrc',
    textMateScope: 'source.ispc',
  );
  ...
  static const LanguageInfo jsonWithComments = LanguageInfo(
    ...
    codeMirrorMode: 'javascript',
    codeMirrorMimeType: 'text/javascript',
    textMateScope: 'source.json.comments',
    group: 'JSON',
  );
  ...
  /// The information provided by linguist about
  /// the "Koka" language or content type.
  static const LanguageInfo koka = LanguageInfo(
    name: 'Koka',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.kk'],
    filenames: [],
    interpreters: ['koka'],
    linguistColor: '#215166',
    aceMode: 'text',
    textMateScope: 'source.koka',
  );
  ...
  /// The information provided by linguist about
  /// the "M3U" language or content type.
  static const LanguageInfo m3U = LanguageInfo(
    name: 'M3U',
    type: LanguageType.data,
    ...
    filenames: [],
    interpreters: [],
    linguistColor: '#179C7D',
    aceMode: 'text',
    textMateScope: 'source.m3u',
  );
  ...
  /// The information provided by linguist about
  /// the "Rocq Prover" language or content type.
  static const LanguageInfo rocqProver = LanguageInfo(
    name: 'Rocq Prover',
    type: LanguageType.programming,
    aliases: ['coq', 'rocq'],
    extensions: ['.v', '.coq'],
  ...
  /// The information provided by linguist about
  /// the "Sail" language or content type.
  static const LanguageInfo sail = LanguageInfo(
    name: 'Sail',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.sail'],
    filenames: [],
    interpreters: [],
    linguistColor: '#259dd5',
    aceMode: 'text',
    textMateScope: 'source.sail',
  );
  ...
  /// The information provided by linguist about
  /// the "Slang" language or content type.
  static const LanguageInfo slang = LanguageInfo(
    name: 'Slang',
    type: LanguageType.programming,
    aliases: [],
    extensions: ['.slang'],
    filenames: [],
    interpreters: [],
    linguistColor: '#1fbec9',
    aceMode: 'text',
    textMateScope: 'source.slang',
  );
  ...
  static const LanguageInfo treeSitterQuery = LanguageInfo(
    ...
    filenames: [],
    interpreters: [],
    linguistColor: '#8ea64c',
    aceMode: 'text',
    textMateScope: 'source.scm',
  );
